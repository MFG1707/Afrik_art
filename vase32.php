                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="inner-content">
                            <p>
                        <img src="assets/images/vase_04.png">
                            </p>
                            <span>Vase de poire fait à la main, vase en bois avec art brûlé, vase en bois de  fleur sèche, vase de pièce centrale, vase tourné en bois</span>
                        </div>
                    </div>
                </div>
            </div>
