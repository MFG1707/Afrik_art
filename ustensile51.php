                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="inner-content">
                            <p>
                        <img src="assets/images/ustensile_05.png">
                            </p>
                            <span>
                            Notre coupe à vin en bois est l'accessoire idéal pour tous les amateurs de vin qui cherchent une alternative écologique et naturelle aux coupes traditionnelles.
                            <br>
                            </span>
                        </div>
                    </div>
