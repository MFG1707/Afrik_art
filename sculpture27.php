                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="inner-content">
                            <p>
                        <img src="assets/images/sculpture_23.png">
                        <img src="assets/images/sculpture_23-1.png">
                            </p>
                            <span>
                            Vintage vieille pièce toeriste africaine en bois sculpté plateau de canoë des années 1950 / 60.<br> Plat de plateau léger en forme de canoë sculpté en bois massif.<br>Très belle forme. Pièce artisanale faite à la main pour le marché touriste en Afrique. 
                            <br>Mesure 4,7cm x 40cm x 13cm
                            </span>
                        </div>
                    </div>
                </div>
