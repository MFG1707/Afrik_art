                ...
                <div class="col-12">
                    <nav class="main-nav">
                        ...
                        <ul class="nav">
                            ...
                            <li class="submenu">
                                <img src="assets/images/llogo-user.png" alt="Image" style="width:30px;height:30px" backgroundcolour="white">
                                <ul>
                                    <li>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="inner-content">
                            <p>
                        <img src="assets/images/sculpture_15.png">
                            </p>
                            <span>
                            Une superbe  figurine en résine effet bois représentant une girafe et un veau de Naturecraft.
                            <br>Couleur Marron Matériau Polyrésine

                          <br>  Profondeur 7,5 cm
                          <br>  Largeur 18,5 cm
                          <br>  Hauteur 29 cm
                          <br>  Poids 0,528 Kg
